...
class PagerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        requireActivity().collapsingToolBar.title = getString(R.string.pager_fragment_title)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val myListAdapter = MyListAdapter(true)
        viewPager.adapter = myListAdapter
        myListAdapter.submitList(getList())
    }
